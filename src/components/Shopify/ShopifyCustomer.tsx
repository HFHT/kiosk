...
export function ShopifyCustomer({ phone, template, customer, anonymous, reset }: ShopifyCustomerInterface) {
            ...
            <Box pos='relative'>
                ...
                <form className=''>
                    ...
                    <Grid grow justify="space-between" align="center" className='pad-above-md'>
                        ...
                        <Grid.Col span={4}>
                            {!anonymous && <TextInput label="First Name" placeholder="First Name..." size='lg'
                                key={form.key('firstName')}
                                {...form.getInputProps('firstName')}
                            />}
                        </Grid.Col>
                        <Grid.Col span={4}>
                            {!anonymous && <TextInput label="Last Name" placeholder="Last Name..." size='lg'
                    ...
                    {!anonymous && <TextInput label="Company Name" size='lg' placeholder="Company name..."
                    ...
                    <Grid grow justify="space-between" align="center">
                        ...
                        <Grid.Col span={2}>
                            {!anonymous && <Checkbox label="Sign up for our newsletter?" size="md"
